...
# This can be dropped into an external project to help locate pico-extras It
# should be include()ed prior to project()
...
if(DEFINED ENV{PICO_EXTRAS_FETCH_FROM_GIT} AND (NOT PICO_EXTRAS_FETCH_FROM_GIT))
  ...
  message(
    "Using PICO_EXTRAS_FETCH_FROM_GIT from environment ('${PICO_EXTRAS_FETCH_FROM_GIT}')"
  )
endif()

if(DEFINED ENV{PICO_EXTRAS_FETCH_FROM_GIT_PATH}
   AND (NOT PICO_EXTRAS_FETCH_FROM_GIT_PATH))
  set(PICO_EXTRAS_FETCH_FROM_GIT_PATH $ENV{PICO_EXTRAS_FETCH_FROM_GIT_PATH})
  message(
    "Using PICO_EXTRAS_FETCH_FROM_GIT_PATH from environment ('${PICO_EXTRAS_FETCH_FROM_GIT_PATH}')"
  )
endif()
  ...
  if(PICO_EXTRAS_FETCH_FROM_GIT)
    ...
    if(PICO_EXTRAS_FETCH_FROM_GIT_PATH)
      get_filename_component(
        FETCHCONTENT_BASE_DIR "${PICO_EXTRAS_FETCH_FROM_GIT_PATH}" REALPATH
    ...
    if(PICO_SDK_PATH AND EXISTS "${PICO_SDK_PATH}/../pico-extras")
      ...
      message(
        "Defaulting PICO_EXTRAS_PATH as sibling of PICO_SDK_PATH: ${PICO_EXTRAS_PATH}"
      )
    endif()
  endif()
endif()
...
if(PICO_EXTRAS_PATH)
  ...
  set(PICO_EXTRAS_FETCH_FROM_GIT
      ...
      CACHE
        BOOL
        "Set to ON to fetch copy of PICO EXTRAS from git if not otherwise locatable"
  )
  set(PICO_EXTRAS_FETCH_FROM_GIT_PATH
      "${PICO_EXTRAS_FETCH_FROM_GIT_PATH}"
      CACHE FILEPATH "location to download EXTRAS")
  ...
  set(PICO_EXTRAS_PATH
      ${PICO_EXTRAS_PATH}
      CACHE PATH "Path to the PICO EXTRAS" FORCE)
